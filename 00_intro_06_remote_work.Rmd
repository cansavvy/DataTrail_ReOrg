...
Ask yourself, what does a healthier version of myself look like? Does it involve you sleeping more? Eating more vegetables? Changing your social group?
...
Make it a habit that once a week and once a day, you sit down and plan your tasks for the week and for the day. Create a schedule for yourself that you can stick to of when you will get work done. Try to set up your schedule in a way that will be best suited for you in addition to your other responsibilities and situations.
...
3. Put in the title of the thing. Let's say its "daycare dropoff".
...
Make it a habit that any time you make an appointment or schedule something you put this in your calendar. If you have a a smart phone, you can download the Google apps in order to keep track of your calendar on your phone. This will make it easy to log things as you make appointments.

#### Budget for data science work

Now that most of calendar should be filled with the items you already know about -- its time to use the rest to fill in with when you will work on your data science work. For this course, this means when you will work on the course material and assignments. But when you enter an internship or data science job, it will be time you will devote to tasks related to those jobs.
...
When it is time to do your data science work, try have the same routine as much as possible. If possible, have a same place you go to to get work done. If you need coffee or caffeine or a snack to get your ready and fueled, bring that with you to your workplace too. Your remote workplace should be:
...
First thing you should do when you sit down to do your data science work is determine what tasks you would like to accomplish in this time. We will practice doing this with a Google Document. There are many task management system out there you may want to try, but a Google doc is perhaps the simplest way to get started (and its free).
...
When you first sit down to work, write down all the tasks you'd like to accomplish in the upcoming weeks and evaluate what tasks you may have listed that you've already done. When you are going about your week, **write down tasks as soon as they arise so you don't forget about them.**
