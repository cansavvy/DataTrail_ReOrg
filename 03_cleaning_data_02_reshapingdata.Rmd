...
For these examples, we'll work with the [`relig_income` dataset available in R](https://tidyr.tidyverse.org/reference/relig_income.html). The data in this dataset includes the income ranges and religions from the Pew religion and income survey.
