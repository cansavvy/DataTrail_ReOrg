...
TODO: finish up this chapter's functions
...
- `Cloud computing` - `involves applications and software that run on shared data centers rather 
than running on the computer sitting in front of you.`
...
- **Share results** - Given everything you are seeing with your data, how do we interpret this? What's our conclusion when it comes to our initial question?
 ...
 <div class = "dictionary">
 - `Descriptive`- `is to understand the components of a data set, describe what they are,
 and explain that description to others who might want to understand the data.`
 ...
 02_getting data_10
 - Comma-separated values (CSV) - plain-text files where all the important information
 in the file is represented by text.
