...
[Nonprofits use data science](https://www.discoverdatascience.org/social-good/nonprofits/) to better further their causes. For example, the Red Cross uses data science to find counties to target for smoke alarm installation campaigns.
