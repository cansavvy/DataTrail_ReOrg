...
Then, return to Posit Cloud and click on "File" > "New File" > "Text File".
...
Note: The code used to generate these reports can be viewed on Posit Cloud [here](https://posit.cloud/spaces/2721/join?access_code=FJyfB5pL5GXnYTuRjFJD5BO5prpfPiMSf3%2F7OfO3).
