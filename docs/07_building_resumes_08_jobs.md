...
At [Airbnb]((https://www.airbnb.com/?logo=1)), there are [three tracks](https://www.linkedin.com/pulse/one-data-science-job-doesnt-fit-all-elena-grewal/){target="_blank"} for data science positions. The [Analytics Track](https://www.airbnb.com/careers/departments/position/38405){target="_blank"}, the [Algorithms Track](https://www.airbnb.com/careers/departments/position/44708){target="_blank"}, and the [Inference Track](https://www.airbnb.com/careers/departments/position/44708){target="_blank"}. Very briefly here, data scientists on the:
