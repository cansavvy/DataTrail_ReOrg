...
As discussed previously, you'll want all your data science projects you be organized from the very beginning. Let's do that now! Make a `data` and `results` folders now.

Open up your .Rmd document, you'll want to change the author of this document to your name at the top of the .Rmd document (in the YAML header). Save this change before moving to the next step.
...
**Note**: If you're stuck on this, refer to the R Markdown lesson in this course if you're stuck on this part (or the next part) of the project.
